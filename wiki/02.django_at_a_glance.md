...
- <a href="image/sitelogo.png" download="sitelogo.png"><img width="50px" height="50px" src="image/sitelogo.png" alt="logo"></a>를 다운로드 받아 ```mysite/news/static/images/``` 디렉토리 밑에 ```"sitelogo.png"``` 명으로 저장합니다.   
